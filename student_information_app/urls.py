...
urlpatterns = [
    ...
    path('student_leave_view1/', StaffViews.student_leave_view1, name="student_leave_view1"),
    path('student_leave_approve1/<leave_id>/', StaffViews.student_leave_approve1, name="student_leave_approve1"),
    path('student_leave_reject1/<leave_id>/', StaffViews.student_leave_reject1, name="student_leave_reject1"),
    ...
    path('subject/', StudentViews.subject, name="subject")
]
