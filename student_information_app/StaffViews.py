...
from student_information_app.models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, \
    Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult, LeaveReportStudent
...
def student_leave_approve1(request, leave_id):
    leave = LeaveReportStudent.objects.get(id=leave_id)
    leave.leave_status = 1
    leave.save()
    return redirect('student_leave_view1')


def student_leave_reject1(request, leave_id):
    leave = LeaveReportStudent.objects.get(id=leave_id)
